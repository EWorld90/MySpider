...
public class Database {
    ...
    public static ArrayList<ArrayList<String>> selectKeyword(String keyword) {
        ...
        try{
            ...
            System.out.println("已返回查询数据，" + urlList.size() +"条");
    ...
    /** 
     * 向数据库写入bookList与urlList两个ArrayList
     * 
     * @param
     * @return code
     */
    public static int writeArrayList(ArrayList<String> bookList, ArrayList<String> urlList) {
        Connection conn = null;
        Statement stmt = null;
        try{
            // 注册 JDBC 驱动
